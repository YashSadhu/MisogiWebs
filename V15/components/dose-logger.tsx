          ...
          <div className="gradient-warning rounded-2xl p-6">
            <div className="flex items-center justify-between text-gray-900">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">Level {rewards.level}</p>
              ...
              <div className="text-right">
                <p className="text-gray-800 text-sm font-medium">Next level in</p>
                <p className="text-2xl font-bold text-gray-900">{100 - (rewards.points % 100)} points</p>
              </div>
            </div>
          </div>
        </CardContent>
