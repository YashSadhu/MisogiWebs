    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Export Buttons */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button onClick={exportToPDF} className="h-16 flex flex-col gap-2">
              <FileText className="w-6 h-6" />
              <span>Export as PDF</span>
              <span className="text-xs opacity-75">Comprehensive report with charts</span>
            </Button>

            <Button onClick={exportToCSV} variant="outline" className="h-16 flex flex-col gap-2">
              <Table className="w-6 h-6" />
              <span>Export as CSV</span>
              <span className="text-xs opacity-75">Raw data for analysis</span>
            </Button>
          </div>
